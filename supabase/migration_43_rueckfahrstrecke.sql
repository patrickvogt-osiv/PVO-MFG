-- ============================================================================
-- Migration 43: "Rückfahrstrecke anlegen" — erstellt aus einer bestehenden
-- eigenen Strecke eine neue Strecke mit umgekehrter Stopp-Reihenfolge.
-- Koordinaten, Entfernungen, Fahrzeiten und Mitfahrbeiträge werden dabei
-- automatisch mit übernommen (nur der jeweiligen Gegenrichtung zugeordnet),
-- da sich an den physischen Orten/Strecken nichts ändert — nur die
-- Reihenfolge dreht sich um.
-- ============================================================================
...
begin
  ...
  -- Name automatisch umdrehen, falls er dem üblichen "Start - Ziel"-Muster
  -- folgt; sonst "(Rückfahrt)" anhängen.
