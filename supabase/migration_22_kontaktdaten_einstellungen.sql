-- ============================================================================
-- Migration 22: Telefon/E-Mail bei den Fahrer-Einstellungen ergänzen, und
-- eine neue Selbstverwaltungs-Funktion für Mitfahrer (Telefon/E-Mail ändern).
-- ============================================================================
-- Im Supabase SQL-Editor ausführen.
-- ============================================================================

-- Fahrer: eigenes Profil inkl. Telefon/E-Mail aktualisieren
...
-- fn_driver_list_trips: Telefon/E-Mail mit ausliefern, damit die
-- Einstellungsseite sie vorbelegen kann
...
-- fn_list_open_trips: Telefon/E-Mail des Mitfahrers mit ausliefern, damit die
-- Einstellungsseite sie vorbelegen kann
