-- ============================================================================
-- Migration 13: order_index in der Stopp-Liste jeder Fahrt mit ausliefern,
-- damit die Fahrtensuche Start- und Zielort in der richtigen Fahrtrichtung
-- prüfen kann (Startort muss vor dem Zielort auf der Strecke liegen).
-- ============================================================================
